        ...
        .then(inst => {
            inst.addProductToStore('iphone 6', 'Cell Phones & Accessories', 'QmXbD3unmtFcWTrWc3ewdfkrkbTwiVjfkUw8YkaSA5ri3Q',
                ...
                .then(() => {
                    ...
                    sealedBid = '0x' + Eutil.keccak256((2 * amt_1) + 'mysecretacc1').toString('hex');
                    return inst.bid(1, sealedBid, {
                        value: 3 * amt_1,
                ...
                .then(() => {
                    ...
                    sealedBid = '0x' + Eutil.keccak256((3 * amt_1) + 'mysecretacc2').toString('hex');
                    return inst.bid(1, sealedBid, {
                        value: 4 * amt_1,
                ...
                .then(() => {
                    ...
                    return inst.revealBid(1, (2 * amt_1).toString(), 'mysecretacc1', {
                        from: web3.eth.accounts[1]
                    })
                })
                ...
                .then(() => {
                    ...
                    return inst.revealBid(1, (3 * amt_1).toString(), 'mysecretacc2', {
                        from: web3.eth.accounts[2]
                    })
                })
